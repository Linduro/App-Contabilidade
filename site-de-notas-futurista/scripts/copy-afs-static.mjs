...
function buildIndexHtml() {
  ...
  const configScript = `
    ...
    <script src="./js/photo-resolver.js?v=22"></script>
    <script src="./js/learning-rules.js?v=22"></script>
    <script src="./js/browser-evaluation.js?v=22"></script>
    <script src="./js/browser-api.js?v=22"></script>`
