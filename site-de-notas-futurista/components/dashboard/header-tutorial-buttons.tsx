        ...
        <div className="flex-1 min-w-0 max-w-2xl flex flex-col gap-1.5">
          ...
          <div data-tour="hp12c" className="flex flex-col gap-1.5">
            <button
              ...
              className={`group w-full min-h-8 px-2 py-1.5 rounded-md border text-[10px] sm:text-xs font-semibold transition-colors flex items-center justify-center gap-1 text-center leading-tight ${
                hp12cOpen
            ...
            {hp12cOpen && (
              <div className="glass-card neon-border rounded-lg p-2 sm:p-2.5 flex justify-center">
